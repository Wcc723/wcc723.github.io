...
![安裝LiveStyle](https://img.casper.tw/images/2014-01-04_153230.png)

選擇：Install Package

![安裝LiveStyle](https://img.casper.tw/images/2014-01-04_153244.png)

接下來輸入LiveStyle，就能安裝LiveStyle擴充功能

![安裝LiveStyle](https://img.casper.tw/images/2014-01-04_153318.png)
...
![安裝Chrome的 LiveStyle 擴充功能](https://img.casper.tw/images/2014-01-04_153622.png)
...
![按F12](https://img.casper.tw/images/2014-01-04_153855.png)

接下來開啟正在做的檔案(直接開就可以了)

![開啟檔案](https://img.casper.tw/images/2014-01-04_154140.png)

修改CSS，不需要存檔，就會發現畫面上的CSS效果跟著改變囉。

![修改CSS](https://img.casper.tw/images/2014-01-04_154152.png)