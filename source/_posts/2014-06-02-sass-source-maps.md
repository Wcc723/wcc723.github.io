...
![](https://img.casper.tw/images/20140602_sass_source_maps01.png)

在General 內可以找到Source > `Enable CSS source maps`，把它選起來後關掉開發者工具。

![](https://img.casper.tw/images/20140602_sass_source_maps02.png)
...
![](https://img.casper.tw/images/20140602_sass_source_maps03.png)

接下來在terminal輸入`compass watch`，會出現兩個檔，一個是之前的screen.css，另一個是screen.css.map，`.map`就是等等要給Chrome看的，所以別太在意他的內容。

![](https://img.casper.tw/images/20140602_sass_source_maps04.png)
...
![](https://img.casper.tw/images/20140602_sass_source_maps05.png)
...
![](https://img.casper.tw/images/20140602_sass_source_maps06.png)

在開發者工具內的`Sources`內可以找到已經加入的資料夾。

![](https://img.casper.tw/images/20140602_sass_source_maps07.png)

對他點擊右鍵，選擇`Map to Network Resource`。

![](https://img.casper.tw/images/20140602_sass_source_maps08.png)

選擇對應的檔案。

![](https://img.casper.tw/images/20140602_sass_source_maps09.png)

接下來，按照原本的Chrome開發者工具使用方法，就可直接修改screen.sass這個檔案，配合著compass、livereload等等，畫面就會自動重整。

![](https://img.casper.tw/images/20140602_sass_source_maps10.png)
