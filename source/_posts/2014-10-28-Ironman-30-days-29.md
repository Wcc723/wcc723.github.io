...
thumbnail: https://img.casper.tw/images/2014ironman/day28_05.png
published: true
---
...
![](https://img.casper.tw/images/2014ironman/day28_00.png)

## 啟動

安裝完後，啟動Tabula他會自動開啟瀏覽器，並且進入Tabula，如果沒有可以手動輸入`127.0.0.1:8080`，再不行請看看8080 port是不是被佔據了(預設為8080 port)。

![](https://img.casper.tw/images/2014ironman/day28_06.png)
...
![](https://img.casper.tw/images/2014ironman/day28_01.png)

#### 2.選擇範圍

選擇範圍是利用圈選的，如果Pdf有相當多頁，可以選擇repeat this selection，就會用相同的大小、位置套用在每個頁面(如果每頁都對不上就手動了...)，至於小技巧，就是要多操作才能體會了。

![](https://img.casper.tw/images/2014ironman/day28_02.png)
...
![](https://img.casper.tw/images/2014ironman/day28_03.png)
...
![](https://img.casper.tw/images/2014ironman/day28_05.png)
