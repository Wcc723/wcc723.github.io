...
![](https://img.casper.tw/images/hotjar/screen_shot_2015-10-07_01.png)

## 測試 heatmap

登入到Dashborad後，他會要求在網站內加入一段 `<script>` ，這段需要有在線上的網站才能夠運行，本文先以這 **http://wcc723.github.io/** 做為測試，將以下 `<script>` 加入網站的主版。

![](https://img.casper.tw/images/hotjar/screen_shot_2015-10-07_02.png)

另外加入後，他會有一個 **驗證script** 按鈕，驗證網頁是否有正確加入，如果正確就會詢問出現以下畫面，讓開發者選擇服務。

![](https://img.casper.tw/images/hotjar/screen_shot_2015-10-07_03.png)

接下來開一個 `Heatmap` 服務，操作上也相當容易，只要填入名稱、網址即可。

![](https://img.casper.tw/images/hotjar/screen_shot_2015-10-07_04.png)

接下來靜置個一段時間...，不然就是自己動手測試(Blog太久沒更新流量降低 orz...)就可以獲得一些些data。

![](https://img.casper.tw/images/hotjar/screen_shot_2015-10-07_05.png)
...
![](https://img.casper.tw/images/hotjar/screen_shot_2015-10-07_06.png)

就這樣使用者的行為被開發者摸得一清二楚!?

![](https://img.casper.tw/images/hotjar/screen_shot_2015-10-07_07.png)
