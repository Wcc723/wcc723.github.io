...
thumbnail: https://img.casper.tw/images/2014ironman/day11_02.png
published: true
---
...
![/images/2014ironman/day11_01.png](https://img.casper.tw/images/2014ironman/day11_01.png)

接下來選擇另存新檔，附檔名選擇.CSV。

![/images/2014ironman/day11_02.png](https://img.casper.tw/images/2014ironman/day11_02.png)

如果用文字編輯器打開，預期會出現下面的結果，而這就是D3所需要的csv格式。

![/images/2014ironman/day11_03.png](https://img.casper.tw/images/2014ironman/day11_03.png)

如果不想自己做，也可以下載我做好的[範例](https://img.casper.tw/demoFile/d3data/d3demoData141011.csv)。
...
```javascript
dataPath = 'https://img.casper.tw/demoFile/d3data/'; //檔案路徑
...
![/images/2014ironman/day11_04.png](https://img.casper.tw/images/2014ironman/day11_04.png)
