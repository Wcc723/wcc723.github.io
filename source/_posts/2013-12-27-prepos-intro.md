...
![prepos](https://img.casper.tw/images/2013-12-27-01.png)

在進入網站後，左方可以選擇下載的版本，大家就選擇要使用的版本下載吧(這次只會介紹他的免費版)。

![prepos](https://img.casper.tw/images/2013-12-27-02.png)

下載後，只要就點兩下解壓縮

![prepos](https://img.casper.tw/images/2013-12-27-03.png)

因為是網路上下載的，所以在prepos.app上按住`cmd` + `滑鼠左鍵` 選擇打開

![prepos](https://img.casper.tw/images/2013-12-27-04.png)

接下來會出現提示視窗，直接按打開就可以了。

![prepos](https://img.casper.tw/images/2013-12-27-05.png)
...
![prepos](https://img.casper.tw/images/2013-12-27-06.png)

這次就拿aShare的原始版型檔做範例吧，只要把資料夾整個拖曳到prepos裡就可以了。

![prepos](https://img.casper.tw/images/2013-12-27-07.png)

丟進去後，他就會列出這個專案裡所有可以編譯檔案。

![prepos](https://img.casper.tw/images/2013-12-27-08.png)

每一個檔案，還能單獨設定其編譯設定。另外在下方有一個地球的圖案(Live preview)，點擊後就會開啟瀏覽器，直接預覽網頁。

![prepos](https://img.casper.tw/images/2013-12-27-8-5.png)

這邊就介紹我最喜歡的功能 跨裝置測試(Multi Device Testing)，點擊Prepos右上方功能列，類似手持裝置的符號。

![prepos](https://img.casper.tw/images/2013-12-27-09.png)

接下來就可以獲得跨裝置的資訊，只要在其他裝置輸入以上網址，或者是利用qrcode就可以預覽這個專案。

![prepos](https://img.casper.tw/images/2013-12-27-091.png)

輸入以上網址，就可以看到Prepos全部的專案

![prepos](https://img.casper.tw/images/2013-12-27-092.png)
...
![prepos](https://img.casper.tw/images/2013-12-27-15.png)

這個是手機版上所看到aShare版型

![prepos](https://img.casper.tw/images/2013-12-27-12.png)

接下來把Sass中的色彩變數改成紅色

![prepos](https://img.casper.tw/images/2013-12-27-16.png)
