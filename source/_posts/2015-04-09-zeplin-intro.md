...
![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_00.png)
...
![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_01.png)

在建立專案時，可以開Androi, iOS, Web，而這些都可以匯出不同的資料，就以Web來說，他可以將色票匯出成Sass的變數。這邊我就先選Web來建立。

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_02.png)

開好專案後會提示在Sketch內按下`cmd + E`，這樣就能夠將設計稿匯入。

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_03.png)

打開Sketch，手邊剛好有一份Bootstrap的Sketch template，就按下`cmd + E`。

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_04.png)

可以看到專案的列表，就把圖片匯入剛剛開的專案上吧。

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_05.png)

接下來回到Zeplin，可以找到剛剛Bootstrap的Sketch template，隨便點個地方，可以看到尺標都標好了，並且將顏色標出。

*如果點的是內文，則可以複製內文*

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_06.png)

右方的色票旁邊有個水滴圖案，如果點了就會標示顏色的"色名" (*色弱救星*)，並且將他加到常用的色彩列表。

*Border and fill設計師都不需要另外標顏色了~*

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_07.png)

Guildeline頁面可以看到剛剛選擇的顏色、畫面上所用到的字型以及輸出CSS。如果點Generate CSS，可以產出如下的Sass變數(色名是Zeplin取的)。

	$limed-oak: #58b957;

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_08.png)

除此之外，也可以按住`cmd`點選畫面上的物件，這樣就可以在物件上寫一些註解，如果多人的話也可以透過這來討論。

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_09.png)

你相信嗎？這是Web版的頁面，就算是工程師也能透過Web版來進行討論，只要先有一個帳號就可以了。

![](https://img.casper.tw/images/zeplin/2015_04_09_zeplin_11.png)
