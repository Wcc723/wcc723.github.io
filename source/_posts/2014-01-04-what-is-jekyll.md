...
![jekyll](https://img.casper.tw/images/2013-12-14-jekyll.png)
...
![Jekyll 流程1](https://img.casper.tw/images/2014-01-04jekyll-flow-01.png)

### Github Page
在push Liquid Template後，之後每次都只需要push文章就可以，而每次push到github上的文章及Template，都會透過Jekyll server轉換為靜態的網站。

![Jekyll 流程2](https://img.casper.tw/images/2014-01-04jekyll-flow-02.png)
