...
![install node js](https://img.casper.tw/images/2015/11/installNodeJs.png)

安裝完以後再打開 Terminal 輸入以下指令，只要有跳出版本號就算成功了(我的版本追不上時代啊～)。

    $ node -v

![](https://img.casper.tw/images/2015/11/node_version.png)
...
![download repo](https://img.casper.tw/images/2015/11/downloadRepo.png)
...
![](https://img.casper.tw/images/2015/11/goToDir.png)
...
![](https://img.casper.tw/images/2015/11/afterGulp.png)

範例的HTML可以看到成果。

![](https://img.casper.tw/images/2015/11/demoHTML.png)
...
![](https://img.casper.tw/images/2015/11/googleIcons.png)
...
![](https://img.casper.tw/images/2015/11/googleIconsToFonts.png)
