...
![搜尋並安裝markdown writer](https://img.casper.tw/images/2015/11/Settings_-__Users_oushimakoto_github_wcc723_github_io_-_Atom.png)

## 設定 Markdown-Writer

設定最重要的...Blog路徑，這如果沒有設定，等等也玩不下去。一樣在設定內可以找到 `Packages`，列表上可以找到剛剛安裝的 `Markdown-Writer`。

![](https://img.casper.tw/images/2015/11/Settings_-__Users_oushimakoto_github_wcc723_github_io_-_Atom2.png)

`Site Local Directory` 這就是必要的設定，這請填入 Jekyll Blog 的本地位置。

![](https://img.casper.tw/images/2015/11/Settings_-__Users_oushimakoto_github_wcc723_github_io_-_Atom3.png)

在開始使用前，在介紹一下快捷鍵的設置。在 command(`cmd + shift + p`) 執行 `Markdown Writer: Create Default keymaps`。

![](https://img.casper.tw/images/2015/11/screen_shot 2015-11-25_0.png)
...
![](https://img.casper.tw/images/2015/11/2015-11-25-better-jekyll-markdown-editor_md_-__Users_oushimakoto_github_wcc723_github_io_-_Atom4.png)
...
![](https://img.casper.tw/images/2015/11/Settings_-__Users_oushimakoto_github_wcc723_github_io_-_Atom4.png)
