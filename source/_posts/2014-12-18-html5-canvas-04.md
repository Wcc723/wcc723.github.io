...
cssdemo: 2013-autumn
jsdemo:
thumbnail: https://img.casper.tw/images/2014-12-18.png
published: true
---
    ...
    <div class="cover">
      <ul class="coverflow-list">
        ...
        <li class="coverflow-item">
          <label for="cover-a">
            <figure class="album-cover">
              <img src="https://img.casper.tw/images/mayday/001.jpg" alt="">
            </figure>
        ...
        <li class="coverflow-item">
          <label for="cover-b">
            <figure class="album-cover">
              <img src="https://img.casper.tw/images/mayday/002.jpg" alt="">
            </figure>
        ...
        <li class="coverflow-item">
          <label for="cover-c">
            <figure class="album-cover">
              <img src="https://img.casper.tw/images/mayday/003.jpg" alt="">
            </figure>
        ...
        <li class="coverflow-item">
          <label for="cover-d">
            <figure class="album-cover">
              <img src="https://img.casper.tw/images/mayday/004.jpg" alt="">
            </figure>
        ...
        <li class="coverflow-item">
          <label for="cover-e">
            <figure class="album-cover">
              <img src="https://img.casper.tw/images/mayday/005.jpg" alt="">
            </figure>
        ...
        <li class="coverflow-item">
          <label for="cover-f">
            <figure class="album-cover">
              <img src="https://img.casper.tw/images/mayday/006.jpg" alt="">
            </figure>
             <figcaption class="album-name">神的孩子都在跳舞</figcaption>
          </label>
        </li>
