...
thumbnail: https://img.casper.tw/images/2014ironman/day12_01.png
published: true
---
...
CSV[範例](https://img.casper.tw/demoFile/d3data/d3demoData141011.csv)。
...
```javascript
dataPath = 'https://img.casper.tw/demoFile/d3data/';
